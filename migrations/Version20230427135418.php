 ...
 */
final class Version20230427135418 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE livre_livre (livre_source INT NOT NULL, livre_target INT NOT NULL, INDEX IDX_3F60D7FFFBC8B886 (livre_source), INDEX IDX_3F60D7FFE22DE809 (livre_target), PRIMARY KEY(livre_source, livre_target)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
